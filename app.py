...
# Description
st.markdown("""
Select a symptom from the list and click **Submit** to get the predicted disease.
[**NOTE:** This app is for demo purposes only. Please consult a doctor if you have any symptoms.]
""")

# User input via a multi-select box
selected_symptoms = st.multiselect("Select Symptoms:", symptoms)

# Button to submit and get prediction
if st.button("Submit"):
    if selected_symptoms:
        # Assuming 'predict_disease_from_symptom' is the function that predicts the disease
        disease_prediction = predict_disease_from_symptom(selected_symptoms)
